...
public class UI_WinScene extends JFrame
{
	...
	public UI_WinScene(Game game)
	{
		 setTitle("Game Over!");
		 setSize(600,600);
		 JLabel background=new JLabel(new ImageIcon("C:\\Users\\USER\\eclipse-workspace\\Item Oyen\\res\\WinScene.png"));
		 kills = game.kills;
		 JLabel totalKills = new JLabel("Total Kills: "+Integer.toString(kills));
		 totalKills.setForeground(Color.WHITE);
		 totalKills.setBounds(265, 260, 100, 100);
		 
		 try {
			 winMusic = new AudioPlayer(9);
			 winMusic.play();
		 }
